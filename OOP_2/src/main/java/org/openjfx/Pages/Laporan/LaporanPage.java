package org.openjfx.Pages.Laporan;
...
public class LaporanPage extends HBox {
    ...
    public LaporanPage() {
        ...
        leftSide.getChildren().addAll(dropdownLabel, dropdown, searchBox);
        ...
        Label daftarLabel = new Label("Pembayaran");
