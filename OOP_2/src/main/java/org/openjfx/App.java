...
import javafx.scene.control.JComboBox;
import javafx.scene.control.JFrame;
...
public class App extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button memberButton = new Button("Update Member/VIP");
    ...
    private void showHomePage() {
        ...
        Label ferin = new Label("13521161 - FERINDYA AULIA BERLIANTY");
    ...
    private void showMemberPage() {
        ...
        String status[] = {"Non-VIP, VIP"};
        JComboBox updateStatus = new JComboBox(status);
        updateStatus.setBounds(200,200,200,40);
        updateStatus.addItem("Ubah Status Member");
